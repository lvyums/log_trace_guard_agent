...
export const APP_CONFIG: AppConfig = {
  ...
  modules: [
    ...
    {
      key: 'advisory', label: '规划咨询', icon: 'TrendCharts',
      desc: '采集方案、架构推荐、平台选型、指导手册',
      children: [
        { path: '/advisory/plan', label: '采集方案', icon: 'Document', tip: '匹配设备型号并生成标准化采集配置方案' },
        { path: '/advisory/arch', label: '架构推荐', icon: 'Share', tip: '根据企业规模推荐日志采集架构' },
        { path: '/advisory/platform', label: '平台选型', icon: 'DataAnalysis', tip: '日志平台对比选型推荐' },
        { path: '/advisory/guide', label: '指导手册', icon: 'Notebook', tip: '根据使用场景生成定制化指导手册' },
      ],
    },
    {
      key: 'fault', label: '故障诊断', icon: 'Warning',
      desc: '诊断日志采集中常见故障并给出修复建议',
      children: [
        { path: '/fault/diagnose', label: '故障诊断', icon: 'Warning', tip: '诊断日志采集中常见故障并给出修复建议' },
      ],
    },
    {
      key: 'script-gen', label: '脚本生成', icon: 'Monitor',
      desc: '正则生成、ES查询、攻击溯源、脚本优化',
      children: [
  ...
  guidance: {
    ...
    moduleTips: {
      ...
      '/advisory/plan': { type: 'warning', title: '采集方案必须满足等保要求', content: '等保2.0要求：日志留存≥180天、传输加密。' },
      '/fault/diagnose': { type: 'warning', title: '故障诊断前先确认基础条件', content: '80%的采集故障是基础问题：网络不通、端口未开放、防火墙拦截。' },
      '/advisory/arch': { type: 'info', title: '架构设计要考虑扩展性', content: '预留30%的采集容量，选择支持水平扩展的架构。' },
      '/advisory/platform': { type: 'info', title: '平台选型要综合考虑', content: '根据企业规模、预算、团队技能选择合适的日志平台。' },
      '/advisory/guide': { type: 'info', title: '指导手册按需定制', content: '场景描述越详细，生成的手册越贴合实际需求。' },
