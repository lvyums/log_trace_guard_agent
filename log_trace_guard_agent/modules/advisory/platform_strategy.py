"""平台选型推荐策略 — 根据企业规模、预算、技能推荐日志分析平台"""

from common.json_util import JsonConfigLoader
from app.settings import settings


class PlatformChooseStrategy:
    """平台选型推荐策略 — 配置化匹配矩阵"""
    ...
    def recommend(
        ...
        """推荐日志分析平台"""
        device_count = device_count or 10
        daily_log_volume = daily_log_volume or "medium"
        budget = budget or "medium"
        team_skill = team_skill or "basic"
...
# 全局单例
platform_choose_strategy = PlatformChooseStrategy()
